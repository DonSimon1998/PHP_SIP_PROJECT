...
<head>
  <title>BONUS PAYMENT SYSTEM</title>
  <meta charset="utf-8">
  ...
  <nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="task-info.php"><span style="color: #ffffff; font-weight: bold;">SAFARICOM</span></a>
      </div>
      ...
      ?>
        ...
        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-nav-custom">
            ...
            <li <?php if ($page_name == "Bonus") {
                  echo "class=\"active\"";
                } ?>><a href="bonus.php">Bonus <span style="font-size:16px; color:#5bcad9;" class="pull-right hidden-xs showopacity glyphicon glyphicon-calendar"></span></a></li>
            <li><a href="?logout=logout">Logout<span style="font-size:16px; color:#5bcad9;" class="pull-right hidden-xs showopacity glyphicon glyphicon-log-out"></span></a></li>
          </ul>
        </div>
