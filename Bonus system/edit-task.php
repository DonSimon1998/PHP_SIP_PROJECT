							...
							<div class="col-md-12">
								<form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
									...
									<div class="form-group">
										...
										<label class="control-label text-p-reset">Bonus</label>
										<div class="">
											<input type="number" placeholder="Bonus" id="bonus" name="bonus" class="form-control rounded-0" value="<?php echo $row['t_bonus']; ?>" <?php if ($user_role != 1) { ?> readonly <?php } ?> val required>
										</div>
									</div>
									<div class="form-group">
